      ...
      <Container maxWidth="lg">
        ...
        <Box sx={{ textAlign: 'center', mb: 6 }}>
          ...
          <Typography variant="h2" gutterBottom>
            {locale === 'en' ? 'Rock Solid Protection & Stability' : 'حماية واستقرار صلب كالصخر'}
          </Typography>
          <Typography 
            variant="h6" 
        ...
        <Box sx={{ mt: 8 }}>
          <Typography variant="h3" textAlign="center" fontWeight={700} gutterBottom>
            {locale === 'en' ? 'Rock Solid - No Shakes, No Worries' : 'صلب كالصخر - بدون اهتزازات، بدون قلق'}
          </Typography>
          ...
          <Grid container spacing={4}>
            ...
            <Grid item xs={12} md={6}>
              <Stack spacing={3} height="100%" justifyContent="center">
                ...
                >
                  <Typography variant="h5" fontWeight={700} gutterBottom>
                    🏔️ {locale === 'en' ? 'Rough Terrain Testing' : 'اختبار التضاريس الوعرة'}
                  </Typography>
                  <Typography variant="body2" color="text.secondary">
                    {locale === 'en'
        ...
        >
          <Typography variant="h3" fontWeight={700} color="white" gutterBottom>
            {locale === 'en' ? 'Lifetime Warranty on Protection' : 'ضمان مدى الحياة على الحماية'}
          </Typography>
          <Typography variant="body1" color="rgba(255, 255, 255, 0.9)" sx={{ maxWidth: 700, mx: 'auto' }}>
            {locale === 'en'
