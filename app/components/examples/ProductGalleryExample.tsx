      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={() => setActiveIndex(prev => Math.min(productImages.length - 1, prev + 1))}
        ...
        <div className="space-y-6">
          <div>
            <p className="text-sm text-gray-500 uppercase tracking-wide">Premium Wheel Covers</p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-gray-700">
              <li className="flex items-start">
                ...
                <div>
                  <strong>Range Boost</strong> – Improves range by up to 10%, for every trip.
                </div>
              </li>
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <div>
                  <strong>Full Protection</strong> – Wrap-around design prevents curb rash & scratches.
                </div>
              </li>
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <div>
                  <strong>Anti-Theft Lock</strong> – Center-lock system, only removable by owner.
                </div>
              </li>
            </ul>
          </div>
