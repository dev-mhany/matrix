...
const features = [
  {
    ...
    description: 'Optimized airflow helps increase up to 10% range, letting you go farther on every charge.',
    image: '/images/features/range-boost.jpg',
    imageAlt: 'Wheel showing aerodynamic design',
  },
  {
    title: 'Center Lock System',
    description: 'The HALOBLK Center Lock offers quick installation with its modular design, saving time and effort. Made with durable POM material and rubber anti-slip gasket.',
    image: '/images/features/center-lock.jpg',
    imageAlt: 'Center lock mechanism detail',
  },
  {
    title: 'CFD-Proven Efficiency',
    description: 'Advanced computational fluid dynamics testing shows improved aerodynamics with a tighter rear wake and lower overall drag at high speeds.',
    image: '/images/features/cfd-analysis.jpg',
    imageAlt: 'CFD analysis visualization',
  },
  {
    title: 'Premium Metallic Finish',
    description: 'The HALODISC Custom Numbers debuts a unique "Metallic Red" cap finish through an advanced five-layer electroplating process.',
