        ...
        <Container maxWidth='lg'>
          ...
          <Grid container spacing={6}>
            ...
            <Grid item xs={12} md={5}>
              <Card
                elevation={2}
                sx={{ p: 4, mb: 3, backgroundColor: 'background.paper' }}
              >
                <Typography variant='h4' gutterBottom color='text.primary'>
                ...
                <Box sx={{ mt: 3 }}>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
                    ...
                    <Box>
                      <Typography variant='h6' color='text.primary'>
                        {content.info.whatsapp.title[locale]}
                      </Typography>
                      <Typography color='text.secondary'>
                        {content.info.whatsapp.text[locale]}
                      </Typography>
                    </Box>
                  </Box>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
                    ...
                    <Box>
                      <Typography variant='h6' color='text.primary'>
                        {content.info.email.title[locale]}
                      </Typography>
                      <Typography color='text.secondary'>
                        {content.info.email.text[locale]}
                      </Typography>
                    </Box>
                  </Box>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    <Box>
                      <Typography variant='h6' color='text.primary'>
                        {content.info.location.title[locale]}
                      </Typography>
                      <Typography color='text.secondary'>
                        {content.info.location.text[locale]}
                      </Typography>
                    </Box>
                  </Box>
                </Box>
