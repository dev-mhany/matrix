      ...
      <Container maxWidth='lg'>
        ...
        <Box sx={{ textAlign: 'center', mb: 6 }}>
          ...
          <Typography variant='h2' gutterBottom>
            {locale === 'en'
              ? 'HALOBLK Center Lock System'
              : 'نظام القفل المركزي HALOBLK'}
          </Typography>
          <Typography
            variant='h6'
            ...
            <Stack spacing={4}>
              <Box>
                <Typography variant='h4' fontWeight={700} gutterBottom>
                  {locale === 'en' ? 'Advanced Locking Mechanism' : 'آلية قفل متقدمة'}
                </Typography>
                  ...
                  <ListItem>
                    ...
                    <ListItemText
                      primary={
                        locale === 'en'
                          ? 'UV-Protected Color'
                          : 'لون محمي من الأشعة فوق البنفسجية'
                      }
                    />
                  </ListItem>
                </List>
