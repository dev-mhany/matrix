...
export const content = {
  ...
  hero: {
    ...
    badges: {
      freeDelivery: {
        en: '⚡ Up to 10% Range Boost',
        ar: '⚡ زيادة المدى بنسبة 10%'
      } as LocalizedString,
      easyInstall: {
        en: '🔒 Anti-Theft Lock',
        ar: '🔒 قفل مضاد للسرقة'
      ...
      customizable: {
        en: '🔢 Custom Numbers 00-99',
        ar: '🔢 أرقام مخصصة 00-99'
      } as LocalizedString
    },
    primaryCta: {
      en: 'Order Now on WhatsApp',
      ar: 'اطلب الآن على واتساب'
    } as LocalizedString,
  ...
  productShowcase: {
    ...
    modelPicker: {
      label: {
        en: 'Select Your Tesla Model',
        ar: 'اختر موديل تسلا الخاص بك'
      } as LocalizedString
    },
  ...
  features: {
    ...
    items: [
      ...
      },
      {
        ...
        description: {
          en: 'Precision-engineered to minimize wind noise for a peaceful journey',
          ar: 'مصممة بدقة لتقليل ضوضاء الرياح لرحلة هادئة'
        } as LocalizedString
      },
      {
        icon: '🔢',
        ...
        description: {
          en: 'Pick any 00–99 and add optional engraving (up to 30 characters). Your Number, Your Story.',
          ar: 'اختر أي رقم 00-99 وأضف نقشًا اختياريًا (حتى 30 حرفًا). رقمك، قصتك.'
        } as LocalizedString
      },
      {
        icon: '🔒',
        ...
        description: {
          en: 'Quick installation with modular design. Anti-theft lock, only removable by owner',
          ar: 'تركيب سريع بتصميم معياري. قفل مضاد للسرقة، يمكن إزالته من قبل المالك فقط'
        } as LocalizedString
      },
      {
        icon: '🛡️',
        ...
        description: {
          en: 'Wrap-around design prevents curb rash & scratches, keeping wheels like new',
          ar: 'تصميم شامل يمنع الخدوش والاحتكاك، يحافظ على العجلات كالجديدة'
        } as LocalizedString
      }
    ]
  },
  ...
  pricing: {
    title: {
      en: 'Premium Quality, Transparent Pricing',
      ar: 'جودة فاخرة، أسعار شفافة'
    } as LocalizedString,
    subtitle: {
      en: 'Free UAE shipping • 14-day money-back guarantee',
      ar: 'شحن مجاني في الإمارات • ضمان استرداد المال لمدة 14 يومًا'
    } as LocalizedString,
    note: {
      en: 'All prices include VAT. Custom designs +AED 200.',
      ar: 'جميع الأسعار تشمل ضريبة القيمة المضافة. التصاميم المخصصة +200 درهم.'
    } as LocalizedString,
    currency: { en: 'AED', ar: 'درهم' } as LocalizedString
  },
  testimonials: {
    title: {
      en: 'Loved by UAE Tesla Owners',
      ar: 'يحبها أصحاب تسلا في الإمارات'
    } as LocalizedString,
    items: [
      {
        quote: {
      ...
      } as TestimonialItem,
      {
        ...
        role: {
          en: 'Model Y Owner, Abu Dhabi',
          ar: 'مالكة موديل Y، أبوظبي'
        } as LocalizedString
      } as TestimonialItem,
      {
        quote: {
        ...
        role: {
          en: 'Model 3 Owner, Sharjah',
          ar: 'مالك موديل 3، الشارقة'
        } as LocalizedString
      } as TestimonialItem
    ] as TestimonialItem[]
  },
  faq: {
    ...
    items: [
      {
        q: {
          en: 'Are these compatible with my Tesla Model 3/Y?',
          ar: 'هل هذه متوافقة مع تسلا موديل 3/Y الخاص بي؟'
        } as LocalizedString,
        a: {
      ...
      {
        q: {
          en: 'Will they really improve my range?',
          ar: 'هل ستحسن مداي حقًا؟'
        } as LocalizedString,
        a: {
      ...
      {
        q: {
          en: 'How long does delivery take in the UAE?',
          ar: 'كم من الوقت يستغرق التوصيل في الإمارات؟'
        } as LocalizedString,
        a: {
      ...
      {
        q: {
          en: 'Can I get a custom design or color?',
          ar: 'هل يمكنني الحصول على تصميم أو لون مخصص؟'
        } as LocalizedString,
        a: {
      ...
      {
        q: {
          en: "What if they don't fit or I change my mind?",
          ar: 'ماذا لو لم تناسب أو غيرت رأيي؟'
        } as LocalizedString,
        a: {
    ...
    bottomCta: {
      en: 'More Questions? Ask on WhatsApp',
      ar: 'المزيد من الأسئلة؟ اسأل على واتساب'
    } as LocalizedString
  },
  finalCta: {
    headline: {
      en: 'Transform Your Tesla Today',
      ar: 'قم بتحويل تسلا الخاصة بك اليوم'
    } as LocalizedString,
    subheadline: {
  ...
  footer: {
    ...
    links: {
      ...
      items: [
        ...
        {
          label: { en: 'Shipping Policy', ar: 'سياسة الشحن' } as LocalizedString,
          href: '/shipping'
        },
        {
          label: { en: 'Returns & Refunds', ar: 'الإرجاع والاسترداد' } as LocalizedString,
          href: '/returns'
        },
        {
          label: { en: 'Terms of Service', ar: 'شروط الخدمة' } as LocalizedString,
          href: '/terms'
        },
        {
          label: { en: 'Privacy Policy', ar: 'سياسة الخصوصية' } as LocalizedString,
          href: '/privacy'
        }
      ]
    },
...
export const mainPage = {
  hero: {
    ...
    badges: {
      freeDelivery: {
        en: '🚚 Free UAE Delivery',
        ar: '🚚 توصيل مجاني في الإمارات'
      } as LocalizedString,
  ...
  stats: {
    title: {
      en: 'Trusted by UAE Drivers',
      ar: 'موثوق به من قبل سائقي الإمارات'
    } as LocalizedString,
    items: [
      {
        number: '1000+',
  ...
  finalCta: {
    headline: {
      en: 'Ready to Transform Your Vehicle?',
      ar: 'هل أنت مستعد لتحويل سيارتك؟'
    } as LocalizedString,
    subheadline: {
...
export const jetourContent = {
  ...
  features: {
    title: {
      en: 'Why Choose Our Accessories',
      ar: 'لماذا تختار إكسسواراتنا'
    } as LocalizedString,
    items: [
      {
        icon: '⚡',
  ...
  lifestyle: {
    title: {
      en: 'Built for UAE Adventures',
      ar: 'مصمم لمغامرات الإمارات'
    } as LocalizedString,
    subtitle: {
    ...
    images: [
      {
        ...
        description: {
          en: 'Perfect for outdoor gear and equipment',
          ar: 'مثالي لمعدات التخييم والمعدات'
        } as LocalizedString
      },
      {
        ...
        title: {
          en: 'Side Steps Style',
          ar: 'أناقة الدرجات الجانبية'
        } as LocalizedString,
        description: {
          en: 'Easy entry and exit with sleek design',
          ar: 'دخول وخروج سهل بتصميم أنيق'
        } as LocalizedString
      },
      {
        src: '/images/jetour/grille-guard-lifestyle-1.jpg',
        title: {
          en: 'Grille Guard Protection',
          ar: 'حماية حارس الشبكة'
        } as LocalizedString,
        description: {
          en: 'Sturdy protection with premium finish',
          ar: 'حماية قوية مع إنهاء فاخر'
        } as LocalizedString
      }
    ]
  },
  pricing: {
    ...
    subtitle: {
      en: 'Free UAE shipping • 14-day guarantee',
      ar: 'شحن مجاني في الإمارات • ضمان 14 يومًا'
    } as LocalizedString,
    currency: { en: 'AED', ar: 'درهم' } as LocalizedString,
    features: [
  ...
  testimonials: {
    title: {
      en: 'Loved by JETOUR T2 Owners',
      ar: 'يحبها أصحاب JETOUR T2'
    } as LocalizedString,
    items: [
      {
        quote: {
        ...
        role: {
          en: 'JETOUR T2 Owner, Dubai',
          ar: 'مالك JETOUR T2، دبي'
        } as LocalizedString
      } as TestimonialItem,
      {
        quote: {
        ...
        role: {
          en: 'JETOUR T2 Owner, Abu Dhabi',
          ar: 'مالكة JETOUR T2، أبوظبي'
        } as LocalizedString
      } as TestimonialItem,
      {
        quote: {
        ...
        role: {
          en: 'JETOUR T2 Owner, Sharjah',
          ar: 'مالك JETOUR T2، الشارقة'
        } as LocalizedString
      } as TestimonialItem
    ] as TestimonialItem[]
  },
  faq: {
    ...
    items: [
      {
        q: {
          en: 'Are these accessories compatible with my JETOUR T2?',
          ar: 'هل هذه الإكسسوارات متوافقة مع JETOUR T2 الخاص بي؟'
        } as LocalizedString,
        a: {
  ...
  finalCta: {
    headline: {
      en: 'Upgrade Your JETOUR T2 Today',
      ar: 'قم بترقية JETOUR T2 الخاص بك اليوم'
    } as LocalizedString,
    subheadline: {
...
export const leopardContent = {
    ...
    images: [
      {
        ...
        description: {
          en: 'Heavy-duty construction for maximum capacity',
          ar: 'بناء قوي لسعة قصوى'
        } as LocalizedString
      },
      {
        src: '/images/leopard/electric-side-steps-lifestyle-1.jpg',
        title: {
          en: 'Electric Side Steps',
          ar: 'الدرجات الجانبية الكهربائية'
        } as LocalizedString,
        description: {
          en: 'Automatic extension with LED lighting',
          ar: 'تمديد تلقائي مع إضاءة LED'
        } as LocalizedString
      }
    ]
  },
  ...
  testimonials: {
    title: {
      en: 'Loved by Leopard Owners',
      ar: 'يحبها أصحاب ليوبارد'
    } as LocalizedString,
    items: [
      {
        quote: {
      ...
      } as TestimonialItem,
      {
        ...
        role: {
          en: 'Leopard Owner, Abu Dhabi',
          ar: 'مالكة ليوبارد، أبوظبي'
        } as LocalizedString
      } as TestimonialItem,
      {
        quote: {
        ...
        role: {
          en: 'Leopard Owner, Sharjah',
          ar: 'مالك ليوبارد، الشارقة'
        } as LocalizedString
      } as TestimonialItem
    ] as TestimonialItem[]
  },
  faq: {
    ...
    items: [
      {
        q: {
          en: 'Are these accessories compatible with my Leopard vehicle?',
          ar: 'هل هذه الإكسسوارات متوافقة مع سيارتي ليوبارد؟'
        } as LocalizedString,
        a: {
  ...
  finalCta: {
    headline: {
      en: 'Upgrade Your Leopard Today',
      ar: 'قم بترقية ليوبارد الخاص بك اليوم'
    } as LocalizedString,
    subheadline: {
      en: 'Join satisfied customers across the UAE. Free delivery, easy install, 14-day guarantee.',
      ar: 'انضم إلى العملاء الراضين في جميع أنحاء الإمارات. توصيل مجاني، تركيب سهل، ضمان 14 يومًا.'
