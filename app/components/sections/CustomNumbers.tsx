...
import { Box, Container, Typography, Grid, Card, CardMedia, Stack, TextField } from '@mui/material';
              ...
              <Stack spacing={4}>
                <Box>
                  <Typography variant="h5" fontWeight={700} gutterBottom>
                    {locale === 'en' ? '🔢 Pick Your Number (00-99)' : '🔢 اختر رقمك (00-99)'}
                  </Typography>
                  <TextField
                    fullWidth
                ...
                <Box>
                  <Typography variant="h5" fontWeight={700} gutterBottom>
                    {locale === 'en' ? '✍️ Custom Text (Optional)' : '✍️ نص مخصص (اختياري)'}
                  </Typography>
                  <TextField
                    fullWidth
                    value={customText}
                    onChange={handleTextChange}
                    placeholder={locale === 'en' ? 'Your message here...' : 'رسالتك هنا...'}
                    multiline
                    rows={2}
                    inputProps={{
                      maxLength: 30,
