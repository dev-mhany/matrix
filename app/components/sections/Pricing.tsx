...
import { Box, Container, Typography, Grid, Card, CardContent, CardMedia, List, ListItem, ListItemIcon, ListItemText } from '@mui/material';
            ...
            <Grid item xs={12} md={4} key={variant.name}>
              <Card
                ...
                sx={{
                  ...
                  transform: variant.name === 'Carbon Fiber Edition' ? 'scale(1.05)' : 'none',
                  overflow: 'hidden',
                }}
              >
