            ...
            >
              ...
              >
                ...
                <Typography variant="body2" color="text.secondary">
                  {locale === 'en' ? 'Fits 18", 19", 20" wheels perfectly' : 'تناسب العجلات مقاس 18" و19" و20" تمامًا'}
                </Typography>
              </Box>
            </Card>
          </Grid>
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              ...
              >
                ...
                <Typography variant="body2" color="text.secondary">
                  {locale === 'en' ? 'Custom numbers on rear wheels' : 'أرقام مخصصة على العجلات الخلفية'}
                </Typography>
              </Box>
            </Card>
          </Grid>
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              ...
              >
                ...
                <Typography variant="body2" color="text.secondary">
                  {locale === 'en' ? 'Aerodynamic efficiency proven' : 'كفاءة ديناميكية هوائية مثبتة'}
                </Typography>
              </Box>
            </Card>
          </Grid>
